...
class AuthDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of AuthDto
        //val modelInstance = AuthDto()
        ...
        // to test the property `sendEmailNotifications`
        should("test sendEmailNotifications") {
            // uncomment below to test the property
            //modelInstance.sendEmailNotifications shouldBe ("TODO")
        }
