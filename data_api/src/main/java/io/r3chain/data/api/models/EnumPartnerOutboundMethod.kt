...
enum class EnumPartnerOutboundMethod(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is EnumPartnerOutboundMethod) "$data" else null

        /**
         * Returns a valid [EnumPartnerOutboundMethod] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): EnumPartnerOutboundMethod? = data?.let {
